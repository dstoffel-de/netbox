# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-10-29 04:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('face', models.PositiveSmallIntegerField(choices=[[0, 'Front'], [1, 'Rear']], verbose_name='Rack face')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.TextField(blank=True)),
                ('manufacturer', models.ForeignKey(blank=True, help_text='Manufacturer (optional)', null=True, on_delete=django.db.models.deletion.PROTECT, related_name='rack_furniture_types', to='dcim.Manufacturer')),
            ],
            bases=(models.Model, extras.models.CustomFieldModel),
        ),
        migrations.AddField(
