...
from .models import (
    ...
    Platform, PowerOutlet, PowerOutletTemplate, PowerPort, PowerPortTemplate, Rack, RackGroup, RackFurniture,
    RackFurnitureType, RackReservation, RackRole, Region, Site,
)
